...
- `jobs/` — orchestration: `dispatch` (brain slots), `tick` (market data + standing orders + ingest), `reflect_run`, `bell` (first-bell stages), `site` (arena.json build), `agent_run`, `seed` (historical one-time v1 migration)
